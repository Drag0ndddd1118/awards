...
| No. | Problem | Current status | Lean proof | Eligible to claim | Claim status |
| --- | --- | --- | --- | --- | --- |
| JSP-000301 | [If two consecutive positive integers are powerful, must at least one be a perfect square?](catalog-0301-0400.md#JSP-000301) | Solved | Yes | No | Unavailable |
